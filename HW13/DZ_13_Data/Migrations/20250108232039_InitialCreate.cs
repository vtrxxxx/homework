    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new TimeSpan(0, 16, 30, 0, 0), 1, "Room1", new DateTime(2025, 1, 9, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 14, 30, 0, 0) },
                    { 2, new TimeSpan(0, 20, 0, 0, 0), 1, "Room2", new DateTime(2025, 1, 9, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 18, 0, 0, 0) },
                    { 3, new TimeSpan(0, 17, 0, 0, 0), 2, "Room3", new DateTime(2025, 1, 9, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 15, 0, 0, 0) },
                    { 4, new TimeSpan(0, 21, 0, 0, 0), 2, "Room4", new DateTime(2025, 1, 9, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 19, 0, 0, 0) }
                });
